...
(function(){
  ...
  var VER=window.ADMIRA_VERSION||'v.14.07.2026.r2';
  ...
  var ICONS={
    ...
    playlists:   _S+'<path d="M4 6.5h10M4 11h10M4 15.5h6"/><path d="M16.5 12.4 21 15l-4.5 2.6z" fill="currentColor" stroke="none"/></svg>',
    parrilla:    _S+'<path d="M4 5h16M4 10h16M4 15h16M4 20h16"/><circle cx="8" cy="5" r="1.6" fill="currentColor" stroke="none"/><circle cx="16" cy="10" r="1.6" fill="currentColor" stroke="none"/><circle cx="8" cy="15" r="1.6" fill="currentColor" stroke="none"/><circle cx="16" cy="20" r="1.6" fill="currentColor" stroke="none"/></svg>',
  ...
  var APPS=[
    ...
    {s:'socialwifi',         nm:'Social WiFi',          en:'Social Wifi',         ds:'WiFi de invitados que convierte visitas en datos.',st:'live'},
    ...
    {s:'olfactorymarketing', nm:'Marketing olfativo',   en:'Olfactory Marketing', ds:'El aroma como canal de marca.',                   st:'live'},
