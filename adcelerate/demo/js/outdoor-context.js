...
(function(root) {
  ...
  function validate(c) {
    if (!c || c.siteId !== 'bcn-kiosk-016' || !finite(c.hour, 0, 23.999999) ||
        ...
        typeof c.manual !== 'boolean' || (c.audienceMode!==undefined&&!['geomex','simulation'].includes(c.audienceMode)) || !['kiosk', 'plaza', 'building'].includes(c.selection) ||
    ...
    return {siteId:c.siteId, hour:c.hour, baseCount:c.baseCount, effectiveCount:c.effectiveCount,...(c.audienceMode!==undefined?{audienceMode:c.audienceMode}:{}),
